...
<!-- staff[member.php限定 js / css] -->
    ...
    <link rel="stylesheet" href="data/staff-v1.3.css">
    <link rel="stylesheet" href="data/loading-screen-v1.1.1.css">
<!-- queryパラ取得 限定[js] -->
    <script src="https://uni-guild.com/js/query/query-v2.1.2.js"></script>
<script>
window.addEventListener('load', function() {
    const loader = document.getElementById('loading-screen');
    // ページ読み込み完了から2.0秒後にフェードアウト
    setTimeout(() => {
...
<div id="loading-screen" class="loading-full-screen">
    <div class="loading-content">
        ...
        <p class="loading-sub-text">
            Connecting to <span class="loading-staff-name"><?php echo htmlspecialchars($member['name']); ?></span>...
        </p>
    </div>
</div>
