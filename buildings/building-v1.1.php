<?php
/**
 * 建築物詳細ページ (building.php) v1.3
 * エラー原因となる全角スペースを完全に除去済み
 */
...
<head>
    ...
    <link rel="stylesheet" href="data/building-v1.2.1.css">
            ...
            <aside class="staff-info-card">
                <div class="staff-visual">
                    <img src="https://uni-guild.com/images/building/<?php echo htmlspecialchars($id_param); ?>_main.jpg" 
                         ...
                         onerror="this.src='https://uni-guild.com/images/build/404_building.png'">
