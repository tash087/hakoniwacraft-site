...
<head>
    ...
    <link rel="stylesheet" href="https://uni-guild.com/buildings/data/building-v1.2.2.2.css">
...
<div id="loading-screen" class="loading-full-screen">
    <div class="loading-content">
        ...
        <p class="loading-sub-text">Loading: <span class="loading-target-name"><?php echo htmlspecialchars($data['name']); ?></span>...</p>
    </div>
</div>
...
<main class="container section-padding">
    <section class="staff-detail-container">
        <div class="staff-hero">
            <h1 class="page-title"><?php echo $data['icon_emoji']; ?> <span class="text-primary-color"><?php echo htmlspecialchars($data['name']); ?></span></h1>
        ...
        <div class="staff-main-layout">
            <aside class="staff-info-card">
                <div class="staff-visual">
                    <img src="https://uni-guild.com/images/building/<?php echo htmlspecialchars($id_param); ?>_main.jpg" 
                         class="staff-large-icon" 
                         onerror="this.src='https://uni-guild.com/images/building/404_building.png'">
                    <div class="staff-status"><?php echo htmlspecialchars($data['status']); ?></div>
                </div>
                <dl class="staff-data-list">
                    <dt>TPコマンド</dt><dd><code>/hltp <?php echo htmlspecialchars($data['hlid']); ?></code></dd>
                    <dt>所在地</dt><dd><?php echo htmlspecialchars($data['location']); ?></dd>
                    <dt>建築主</dt><dd><?php echo htmlspecialchars($data['builder']); ?></dd>
                    <dt>スタイル</dt><dd><?php echo htmlspecialchars($data['style']); ?></dd>
                </dl>
            </aside>
...
<script>
    window.addEventListener('load', () => {
        setTimeout(() => { document.getElementById('loading-screen')?.classList.add('loaded'); }, 800);
    });
</script>
</body>
</html>